...
var (
	humioCluster1 = &humioClusterv1alpha1.HumioCluster{
...
func TestReconcileHumioCluster_Reconcile(t *testing.T) {
	...
	s := scheme.Scheme
	s.AddKnownTypes(humioClusterv1alpha1.SchemeGroupVersion, humioCluster1)
	...
	req := reconcile.Request{
		NamespacedName: types.NamespacedName{
			Name:      humioCluster1.ObjectMeta.Name,
			Namespace: humioCluster1.ObjectMeta.Namespace,
		},
	}
	...
	pod := &corev1.Pod{}
	err = cl.Get(context.TODO(), types.NamespacedName{Name: fmt.Sprintf("%s-pod", humioCluster1.ObjectMeta.Name), Namespace: humioCluster1.ObjectMeta.Namespace}, pod)
	if err != nil {
		t.Fatalf("get pod: (%v). %+v", err, pod)
	}
