...
func getCASecretName(hc *humioClusterv1alpha1.HumioCluster) string {
...
func useExistingCA(hc *humioClusterv1alpha1.HumioCluster) bool {
...
func constructCAIssuer(hc *humioClusterv1alpha1.HumioCluster) cmapi.Issuer {
	return cmapi.Issuer{
...
func constructClusterCACertificateBundle(hc *humioClusterv1alpha1.HumioCluster) cmapi.Certificate {
...
func constructNodeCertificate(hc *humioClusterv1alpha1.HumioCluster, nodeSuffix string) cmapi.Certificate {
	return cmapi.Certificate{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: hc.Namespace,
