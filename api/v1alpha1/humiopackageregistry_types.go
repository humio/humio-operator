...
const (
	// PackageRegistryConditionTypeReady indicates whether the PackageRegistry is ready
	PackageRegistryConditionTypeReady = "Ready"
	// PackageRegistryConditionTypeSynced indicates whether the PackageRegistry is synchronized with Humio
	PackageRegistryConditionTypeSynced = "Synced"
)

const (
	// PackageRegistryReasonReady indicates the PackageRegistry is ready
	PackageRegistryReasonReady = "Ready"
	// PackageRegistryReasonActive indicates the PackageRegistry is active
	PackageRegistryReasonActive = "Active"
	// PackageRegistryReasonDisabled indicates the PackageRegistry is disabled
	PackageRegistryReasonDisabled = "Disabled"
	// PackageRegistryReasonConfigError indicates a configuration error
	PackageRegistryReasonConfigError = "ConfigurationError"
	// PackageRegistryReasonUnknown indicates the PackageRegistry state is unknown
	PackageRegistryReasonUnknown = "Unknown"
)
