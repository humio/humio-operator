...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HumioBootstrap) DeepCopyInto(out *HumioBootstrap) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HumioBootstrap.
func (in *HumioBootstrap) DeepCopy() *HumioBootstrap {
	if in == nil {
		return nil
	}
	out := new(HumioBootstrap)
	in.DeepCopyInto(out)
	return out
}
