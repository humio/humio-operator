...
func TestAPIs(t *testing.T) {
	...
	RunSpecs(t, "HumioClusterGroup Controller Suite")
}
...
var _ = BeforeSuite(func() {
	...
	testProcessNamespace = fmt.Sprintf("e2e-clustergroups-%d", GinkgoParallelProcess())
...
var _ = ReportAfterSuite("HumioClusterGroup Controller Suite", func(suiteReport ginkgotypes.Report) {
