...
const (
	image                        = "humio/humio-core:1.32.0"
	helperImage                  = "humio/humio-operator-helper:0.4.0"
...
func setEnvironmentVariableDefaults(hc *humiov1alpha1.HumioCluster) {
	...
	envDefaults := []corev1.EnvVar{
		...
		{Name: "HUMIO_JVM_ARGS", Value: "-Xss2m -Xms256m -Xmx2G -server -XX:+UseParallelOldGC -XX:+ScavengeBeforeFullGC -XX:+DisableExplicitGC"},
