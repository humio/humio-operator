...
docker-build-operator:
	docker buildx build --no-cache --pull --platform linux/amd64 -o type=docker -t ${IMG} ${IMG_BUILD_ARGS} .

# Build the helper docker image
docker-build-helper:
	cp LICENSE images/helper/
	docker buildx build --no-cache --pull --platform linux/amd64 -o type=docker -t ${IMG} ${IMG_BUILD_ARGS} images/helper
