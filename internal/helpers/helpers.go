...
func UseCertManager() bool {
	return !UseEnvtest() && os.Getenv("USE_CERTMANAGER") == configEnvVarEnabled
}
...
func UseEnvtest() bool {
	return os.Getenv("TEST_USING_ENVTEST") == configEnvVarEnabled
}
...
func UseDummyImage() bool {
	return os.Getenv("DUMMY_LOGSCALE_IMAGE") == configEnvVarEnabled
}
...
func PreserveKindCluster() bool {
	return os.Getenv("PRESERVE_KIND_CLUSTER") == configEnvVarEnabled
}
