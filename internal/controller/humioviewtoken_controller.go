...
func (r *HumioViewTokenReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var humioViewToken *humiographql.TokenDetailsViewPermissionsToken
	var lastErr error
...
func (r *HumioViewTokenReconciler) validateExpireAt(hvt *humiov1alpha1.HumioViewToken, vt *humiographql.TokenDetailsViewPermissionsToken) error {
...
func (r *HumioViewTokenReconciler) validateIPFilter(ctx context.Context, client *humioapi.Client, hvt *humiov1alpha1.HumioViewToken, vt *humiographql.TokenDetailsViewPermissionsToken) (*humiographql.IPFilterDetails, error) {
...
func (r *HumioViewTokenReconciler) validateViews(ctx context.Context, humioClient *humioapi.Client, hvt *humiov1alpha1.HumioViewToken, vt *humiographql.TokenDetailsViewPermissionsToken) ([]string, error) {
...
func (r *HumioViewTokenReconciler) viewTokenAlreadyAsExpected(fromK8s *humiov1alpha1.HumioViewToken, fromGql *humiographql.TokenDetailsViewPermissionsToken) (bool, map[string]string) {
