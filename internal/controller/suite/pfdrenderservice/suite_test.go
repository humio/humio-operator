...
func TestAPIs(t *testing.T) {
	...
	RunSpecs(t, "HumioPDFRenderService Controller Suite")
}
...
var _ = BeforeSuite(func() {
	...
	testProcessNamespace = fmt.Sprintf("e2e-pdf-render-service-%d", GinkgoParallelProcess())
...
var _ = ReportAfterSuite("HumioPDFRenderService Controller Suite", func(suiteReport ginkgotypes.Report) {
