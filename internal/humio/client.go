...
type SecurityPoliciesClient interface {
	UpdateTokenSecurityPolicy(context.Context, *humioapi.Client, humiographql.TokenSecurityPolicies) error
	NewTokenSecurityPolicies() humiographql.TokenSecurityPolicies
}
...
func (h *ClientConfig) UpdateTokenSecurityPolicy(ctx context.Context, client *humioapi.Client, tp humiographql.TokenSecurityPolicies) error {
	_, err := humiographql.UpdateTokenSecurityPolicies(ctx, client, tp)
	return err
}

// NewTokenSecurityPolicies creates a new TokenSecurityPolicies with default values
func (h *ClientConfig) NewTokenSecurityPolicies() humiographql.TokenSecurityPolicies {
